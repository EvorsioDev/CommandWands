...
import static ru.armagidon.commandwands.config.serializers.KeyedSerializer.keyedEnumSerializer;
...
import ru.armagidon.commandwands.config.serializers.BannerPatternSerializer;
import ru.armagidon.commandwands.config.serializers.BlockDataSerializer;
import ru.armagidon.commandwands.config.serializers.ColorSerializer;
import ru.armagidon.commandwands.config.serializers.ComponentSerializer;
import ru.armagidon.commandwands.config.serializers.EnchantmentMapSerializer;
import ru.armagidon.commandwands.config.serializers.FireworkEffectSerializer;
import ru.armagidon.commandwands.config.serializers.KeyedSerializer;
import ru.armagidon.commandwands.config.serializers.MultimapSerializer;
import ru.armagidon.commandwands.config.serializers.NamespacedKeySerializer;
import ru.armagidon.commandwands.config.serializers.OfflinePlayerSerializer;
import ru.armagidon.commandwands.config.serializers.PotionDataSerializer;
import ru.armagidon.commandwands.config.serializers.PotionEffectSerializer;
import ru.armagidon.commandwands.config.serializers.ProfilePropertySerializer;
